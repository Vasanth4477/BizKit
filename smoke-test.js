...
const app=fs.readFileSync('app.js','utf8'),router=fs.readFileSync('app-router.js','utf8'),pkg=JSON.parse(fs.readFileSync('package.json','utf8'));if(pkg.version!=='0.7.1') throw Error('Package version mismatch');
